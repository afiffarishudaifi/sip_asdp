...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <form action="<?php echo base_url('Karyawan/JasaSandar/add_jasasandar'); ?>" method="post" id="form_add"
        ...
        <!-- Modal Edit Class-->
        <form action="<?php echo base_url('Karyawan/JasaSandar/update_jasasandar'); ?>" method="post" id="form_edit"
            data-parsley-validate="true" autocomplete="off" enctype="multipart/form-data">
        ...
        <form action="<?php echo base_url('Karyawan/JasaSandar/delete_jasasandar'); ?>" method="post">
    ...
    <script>
        ...
        function cekgrt(status) {
            $.getJSON('<?php echo base_url('Karyawan/JasaSandar/cek_grt'); ?>' + '/' + status, {},
                function(json) {
        ...
        function detail_edit(isi) {
            $.getJSON('<?php echo base_url('Karyawan/JasaSandar/data_edit'); ?>' + '/' + isi, {},
                function(json) {
