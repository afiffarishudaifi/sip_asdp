...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <form action="<?= base_url('Karyawan/User/add_user'); ?>" method="post" id="form_add"
        ...
        <!-- Modal Edit Class-->
        <form action="<?php echo base_url('Karyawan/User/update_user'); ?>" method="post" id="form_edit"
            data-parsley-validate="true" autocomplete="off" enctype="multipart/form-data">
        ...
        <form action="<?php echo base_url('Karyawan/User/delete_user'); ?>" method="post">
    ...
    <script>
        ...
        function detail_edit(isi) {
            $.getJSON('<?= base_url('Karyawan/User/data_edit'); ?>' + '/' + isi, {},
                function(json) {
            ...
            $("#input_username").keyup(function(){
                ...
                if(username != ''){
                    $.ajax({
                        type: 'GET',
                        dataType: 'json',
                        url: '<?php echo base_url('Karyawan/User/cek_username'); ?>' + '/' + username,
