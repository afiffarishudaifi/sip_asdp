...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <form action="<?php echo base_url('Karyawan/Kapal/add_kapal'); ?>" method="post" id="form_add"
        ...
        <!-- Modal Edit Class-->
        <form action="<?php echo base_url('Karyawan/Kapal/update_kapal'); ?>" method="post" id="form_edit"
            data-parsley-validate="true" autocomplete="off">
        ...
        <form action="<?php echo base_url('Karyawan/Kapal/delete_kapal'); ?>" method="post">
    ...
    <script>
            ...
            $("#input_nama").keyup(function(){
                ...
                if(nama != ''){
                    $.ajax({
                        type: 'GET',
                        dataType: 'json',
                        url: '<?php echo base_url('Karyawan/Kapal/cek_nama'); ?>' + '/' + nama,
        ...
        function detail_edit(isi) {
            $.getJSON('<?php echo base_url('Karyawan/Kapal/data_edit'); ?>' + '/' + isi, {},
                function(json) {
                    $('#id').val(json.id);
